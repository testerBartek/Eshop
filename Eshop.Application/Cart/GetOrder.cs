...
namespace Eshop.Application.Cart
{
    public class GetOrder
    {
        ...
        public Response Do()
        {
            ...
            var listOffProducts = _ctx.Stock
                .Include(x => x.Product)
                .AsEnumerable()
            ...
            var customerInformation = JsonConvert.DeserializeObject<Eshop.Domain.Models.CustomerInformation>(customerInfoString);

            return new Response
            {
                Products = listOffProducts,
